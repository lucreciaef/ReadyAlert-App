...
export const LIGHT_MAP_STYLE: MapStyleElement[] = [
  ...
  { featureType: 'administrative.country', elementType: 'labels.text.fill', stylers: [{ color: '#2a2a2a' }] },
  ...
  { featureType: 'road.highway.controlled_access', elementType: 'geometry', stylers: [{ color: '#d5d5d5' }] },
